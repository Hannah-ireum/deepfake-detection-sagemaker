...
Fine-tuning 전, FaceForensics++ 사전 학습 모델의 딥페이크 탐지 성능을 평가합니다.
...
FaceForensics++는 대표적인 딥페이크 탐지 벤치마크입니다. 다양한 딥페이크 생성 기법으로 만들어진 데이터로 학습되었습니다.
...
사전 학습된 모델이 새로운 데이터에서 성능이 저하될 수 있는 이유:
